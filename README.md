...
## Dormant finance integrations

Stripe and Coinbase are not part of the active OSIRIS runtime. Their former
implementation remains recoverable from Git history, but the application does
not expose finance pages, API procedures, webhooks, or readiness checks. Do not
configure Stripe or Coinbase credentials unless the feature is deliberately
