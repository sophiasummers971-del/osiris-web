      ...
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div className="text-center mb-16">
          <div className="inline-block mb-4 px-4 py-2 rounded-lg bg-primary/10 border border-primary/30">
            <span className="text-sm font-semibold text-primary">Support the Creator</span>
          </div>
          <h2 className="text-4xl font-bold mb-4 text-foreground">
            Join the Community
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Support AI-driven content, visuals, and digital systems. Get early access to experiments, behind-the-scenes drops, and exclusive ideas.
          </p>
        </div>
          ...
          {tiers.map((tier, idx) => (
            <div
              ...
              className={`rounded-lg border transition-all ${
                tier.highlighted
                  ? 'border-primary/50 shadow-lg scale-105 bg-gradient-to-br ' + tier.color
            ...
            >
              ...
              <div className="p-8">
                {/* Icon */}
                <div className={`mb-4 ${tier.highlighted ? 'text-white' : 'text-primary'}`}>
                  {tier.icon}
                </div>
                ...
                {/* Price */}
                <div className={`text-3xl font-bold mb-6 ${tier.highlighted ? 'text-white' : 'text-primary'}`}>
                  {tier.price}
                </div>
