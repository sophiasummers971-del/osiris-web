...
export default function SupporterHub() {
  const [selectedTier, setSelectedTier] = useState<'all' | 'coffee' | 'patron' | 'vip'>('all');
  const [userTier, setUserTier] = useState<'none' | 'coffee' | 'patron' | 'vip'>('none');

  const exclusiveContent: ExclusiveContent[] = [
    {
      id: '1',
      title: 'Behind-the-Scenes AI Art Process',
      description: 'Watch how I create stunning AI art from concept to final render',
      tier: 'patron',
      type: 'video',
      icon: <Video className="w-5 h-5" />,
      date: '2026-05-15',
      preview: 'See the complete workflow, tools, and techniques I use for AI art generation.',
    },
    {
      id: '2',
    ...
    },
    {
      ...
      date: '2026-05-08',
      preview: 'Learn professional techniques for creating gallery-quality AI art.',
    },
    {
      id: '4',
    ...
    },
    {
      ...
      description: 'First access to new OSINT and AI tools before public release',
      tier: 'coffee',
      type: 'post',
  ...
  const canAccess = (contentTier: string) => {
    ...
    if (userTier === 'patron' && (contentTier === 'patron' || contentTier === 'coffee')) return true;
      ...
      <section className="border-b border-border/50 py-12">
        <div className="container mx-auto max-w-6xl px-4">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl">
            Exclusive content, early access, and behind-the-scenes drops for our amazing supporters.
          </p>
        </div>
      </section>
            ...
            {filteredContent.map((content) => (
              <Card
                ...
                className={`relative border-border/50 ${
                  canAccess(content.tier) ? 'bg-card/50' : 'bg-card/30 opacity-75'
                }`}
              >
        ...
        <div className="container mx-auto max-w-6xl px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              {
                title: 'Community',
                description: 'Join a supportive community of creators and innovators',
              },
            ].map((benefit, idx) => (
      ...
      <section className="py-12">
        <div className="container mx-auto max-w-4xl px-4 text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Join our community and get exclusive access to behind-the-scenes content, early releases, and more.
          </p>
          <Button
            size="lg"
            className="bg-primary hover:bg-primary/90"
